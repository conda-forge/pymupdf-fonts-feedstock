...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pymupdf-fonts-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pymupdf-fonts-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pymupdf-fonts
# for installing globally
pixi global install pymupdf-fonts
```
...
It is possible to list all of the versions of `pymupdf-fonts` available on your platform:
...
```
pixi search pymupdf-fonts --channel conda-forge
```
